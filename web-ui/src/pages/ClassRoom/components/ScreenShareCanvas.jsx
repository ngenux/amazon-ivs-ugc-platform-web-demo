...
const SharedCanvas = ({
  ...
  const updateCanvas = () => {
    if (imageRef.current) {
      // This triggers a re-render of the Konva Image component to display the current video frame
  ...
  useEffect(() => {
    ...
    navigator.mediaDevices.getUserMedia({ video: true })
      .then(stream => {
        ...
        requestAnimation(); // Start the animation loop
      })
      .catch(err => console.error("Error accessing webcam:", err));

    return () => {
      // Cleanup: stop the stream and animation frame
